...
export const CATEGORY_IMAGES: Record<Category, string> = {
  [Category.GIFTS]: '/products/gift_velvet_box_red.jpg',
  [Category.KITCHEN_TOOLS]: '/products/kit_bamboo_boards.jpg',
  [Category.BIRTHDAY_PARTY]: '/products/bday_banner_gold.jpg',
  [Category.BALLOONS_HELIUM]: '/products/bal_number_1_silver.jpg',
  [Category.CUPS_PLATES]: '/products/cup_paper_goldrim.jpg',
  [Category.BAGS_PACKAGING]: '/products/bag_kraft_small.jpg',
  [Category.CAFE_SUPPLIES]: '/products/cafe_cup_ripple.jpg',
  [Category.KIDS_TOYS]: '/products/kid_cube_keychain.jpg',
  [Category.HALLOWEEN]: '/products/hal_pumpkin_bucket.jpg',
  [Category.PACKAGING_MATERIALS]: '/products/pack_honeycomb.jpg',
};
...
export const MOCK_PRODUCTS: Product[] = [
  ...
  // 2. KITCHEN TOOLS
  {
    ...
    category: Category.KITCHEN_TOOLS,
    price: 450,
    stock: 25,
  ...
  // 4. BALLOONS & HELIUM
  {
    ...
    category: Category.BALLOONS_HELIUM,
    price: 75,
    stock: 200,
  ...
  // 6. BAGS & PACKAGING
  {
    ...
    category: Category.BAGS_PACKAGING,
    price: 200,
    stock: 100,
  ...
  // 7. CAFE SUPPLIES
  {
    ...
    category: Category.CAFE_SUPPLIES,
    price: 250,
    stock: 80,
  ...
  // 10. PACKAGING MATERIALS
  {
    ...
    category: Category.PACKAGING_MATERIALS,
    price: 220,
    stock: 40,
